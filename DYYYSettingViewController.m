...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"設置預設倍速" key:@"DYYYDefaultSpeed" type:DYYYSettingItemTypePicker],
            [DYYYSettingItem itemWithTitle:@"設置長按倍速" key:@"DYYYLongPressSpeed" type:DYYYSettingItemTypePicker],
            ...
            [DYYYSettingItem itemWithTitle:@"忽略投屏 VPN 檢測" key:@"DYYYDisableCastVPNCheck" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"全局HDR設置" key:@"DYYYHDRMode" type:DYYYSettingItemTypePicker],
            ...
            [DYYYSettingItem itemWithTitle:@"去青少年彈窗" key:@"DYYYHideTeenMode" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"國外解析帳號" key:@"DYYYGeonamesUsername" type:DYYYSettingItemTypeTextField placeholder:@"需填寫才能解析國外"],
            [DYYYSettingItem itemWithTitle:@"時間標籤顏色" key:@"DYYYLabelColor" type:DYYYSettingItemTypeTextField placeholder:@"十六進位"],
            [DYYYSettingItem itemWithTitle:@"屬地隨機漸層" key:@"DYYYEnableRandomGradient" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            [DYYYSettingItem itemWithTitle:@"設置頂欄透明" key:@"DYYYTopBarTransparent" type:DYYYSettingItemTypeTextField placeholder:@"0-1小數"],
            [DYYYSettingItem itemWithTitle:@"設置全局透明" key:@"DYYYGlobalTransparency" type:DYYYSettingItemTypeTextField placeholder:@"0-1小數"],
            ...
            [DYYYSettingItem itemWithTitle:@"設置首頁標題" key:@"DYYYIndexTitle" type:DYYYSettingItemTypeTextField placeholder:@"不填預設"],
            [DYYYSettingItem itemWithTitle:@"設置朋友標題" key:@"DYYYFriendsTitle" type:DYYYSettingItemTypeTextField placeholder:@"不填預設"],
            [DYYYSettingItem itemWithTitle:@"設置消息標題" key:@"DYYYMsgTitle" type:DYYYSettingItemTypeTextField placeholder:@"不填預設"],
            [DYYYSettingItem itemWithTitle:@"設置我的標題" key:@"DYYYSelfTitle" type:DYYYSettingItemTypeTextField placeholder:@"不填預設"]
        ],
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏底欄消息" key:@"DYYYHideMessageButton" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏常用小程式" key:@"DYYYHideSidebarRecentApps" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏頭像及周邊" key:@"DYYYHideAvatarButton" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏消息頂欄紅包" key:@"DYYYHideMessageTabRedPacket" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏動圖標籤" key:@"DYYYLiveGIF" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏添加朋友" key:@"DYYYHideButton" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏展開漸層" key:@"DYYYHideGradient" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            [DYYYSettingItem itemWithTitle:@"精簡長按面板" key:@"DYYYSimplifyLongPressPanel" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"隱藏面板項目" key:@"DYYYHidePanelItems" type:DYYYSettingItemTypeTextField placeholder:@"逗號分隔按鈕名"],
            ...
            [DYYYSettingItem itemWithTitle:@"隱藏評論保存" key:@"DYYYHideCommentLongPressSaveImage" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"隱藏評論檢舉" key:@"DYYYHideCommentLongPressReport" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"長按面板保存影片" key:@"DYYYLongPressSaveVideo" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"長按面板保存封面" key:@"DYYYLongPressSaveCover" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"長按面板保存音訊" key:@"DYYYLongPressSaveAudio" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"長按面板保存圖片" key:@"DYYYLongPressSaveCurrentImage" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"長按保存所有圖片" key:@"DYYYLongPressSaveAllImages" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"長按面板介面解析" key:@"DYYYLongPressApiDownload" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"雙擊面板保存影片" key:@"DYYYDoubleTapDownload" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"雙擊面板保存音訊" key:@"DYYYDoubleTapDownloadAudio" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"雙擊面板介面解析" key:@"DYYYDoubleInterfaceDownload" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"雙击面板點讚影片" key:@"DYYYDoubleTapLike" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"啟用雙擊打開菜單" key:@"DYYYEnableDoubleTapMenu" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"介面解析保存媒體" key:@"DYYYInterfaceDownload" type:DYYYSettingItemTypeTextField placeholder:@"不填關閉"],
            [DYYYSettingItem itemWithTitle:@"介面顯示清晰選項" key:@"DYYYShowAllVideoQuality" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"禁用點擊首頁刷新" key:@"DYYYDisableHomeRefresh" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"禁用雙擊影片點讚" key:@"DYYYDisableDoubleTapLike" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"啟用保存他人頭像" key:@"DYYYEnableSaveAvatar" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"保存評論區表情包" key:@"DYYYForceDownloadEmotion" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"保存預覽頁表情包" key:@"DYYYForceDownloadPreviewEmotion" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"保存聊天頁表情包" key:@"DYYYForceDownloadIMEmotion" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"下載完成震動反饋" key:@"DYYYHapticFeedbackEnabled" type:DYYYSettingItemTypeSwitch]
        ],
        @[
            [DYYYSettingItem itemWithTitle:@"啟用快捷倍速按鈕" key:@"DYYYEnableFloatSpeedButton" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"快捷倍速數值設置" key:@"DYYYSpeedSettings" type:DYYYSettingItemTypeTextField placeholder:@"逗號分隔"],
            [DYYYSettingItem itemWithTitle:@"自動恢復預設倍速" key:@"DYYYAutoRestoreSpeed" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"倍速按鈕顯示字尾" key:@"DYYYSpeedButtonShowX" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"清屏隱藏倍速按鈕" key:@"DYYYHideSpeed" type:DYYYSettingItemTypeSwitch]
        ]
    ];
}

- (void)setupSectionTitles {
    self.sectionTitles = [@[ @"基本設置", @"介面設置", @"隱藏設置", @"頂欄移除", @"隱藏面板", @"面板設置", @"功能設置", @"懸浮按鈕" ] mutableCopy];
}
...
- (void)showAgreementAlert {
    UIAlertController *alertController =
        [UIAlertController alertControllerWithTitle:@"用戶協議"
                                            message:@"本外掛為開源專案\n僅供學習交流用途\n如有侵權請聯繫, GitHub 倉庫：huami1314/DYYY\n請遵守當地法律法規, "
                                                    @"逆向工程僅為學習目的\n盜用源碼進行商業用途/發布但未標記開源專案必究\n詳情請參閱專案內 MIT 許可證\n\n請輸入\"我已閱讀並同意繼續使用\"以繼續使用"
