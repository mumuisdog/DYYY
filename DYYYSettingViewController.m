...
- (void)setupSettingItems {
    self.settingSections = @[
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"長按儲存創建影片" key:@"DYYYLongPressCreateVideo" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"影片降噪人聲增強" key:@"DYYYEnableNoiseFilter" type:DYYYSettingItemTypeSwitch]
        ],
        @[
