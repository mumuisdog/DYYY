...
static NSString *const kDYYYDefaultSpeedSettingsString = @"1.0,1.25,1.5,2.0,2.5,3.0";
...
BOOL DYYYNormalizeSpeedSettingsForRequiredSpeeds(void) {
    ...
    NSString *speedConfig = [defaults stringForKey:@"DYYYSpeedSettings"];
...
NSArray *getSpeedOptions() {
    ...
    NSString *speedConfig = [defaults stringForKey:@"DYYYSpeedSettings"] ?: kDYYYDefaultSpeedSettingsString;
    NSArray<NSString *> *validSpeeds = DYYYParsedSpeedOptionsFromString(speedConfig);
